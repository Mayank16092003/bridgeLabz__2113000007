...
public class UniversityManagement {
    public static void main(String[] args) {
        Professor professor1 = new Professor("Dr. Vinay");
        Professor professor2 = new Professor("Dr. Abhay");
        ...
        Student student1 = new Student("Mayank");
        Student student2 = new Student("Saurabh");
